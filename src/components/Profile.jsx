      ...
      <div className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8">
        ...
        <div className="flex items-center gap-3 my-2">
            ...
            <div className="my-5">
              ...
              {
                user?.profile?.skills.length!==0?user?.profile?.skills.map((item,index) => <Badge className="bg-black text-white rounded-full mr-2" key={index}>{user?.profile?.skills[index]}</Badge>):<span>NA</span>
              }
              </div>
            </div>
